...
const Services = () => {
  return (
    <div className="w-full bg-[linear-gradient(to_right,rgba(66,93,130,0.1),rgba(255,255,255,0.2))] py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto scroll-mt-[80px] sm:scroll-mt-[100px]" id="services">
        <div className="text-center space-y-4 mb-8">
          <p className="text-[#425d82] text-3xl sm:text-4xl font-semibold">
            Services Rendered
          </p>
          <p className="text-gray-800 text-base sm:text-lg">
            End-to-end development solutions designed to transform your ideas into reality
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {[
            ...
            <div
              key={title}
              className="group bg-[#3c3c3c]/10 rounded-xl shadow-xl p-6 flex flex-col items-center hover:shadow-md cursor-pointer transition"
            >
              <Icon className={`text-[52px] text-[${color}] group-hover:text-[${color}]/50 transition`} />
              <p className={`mt-3 text-[${color}] font-semibold text-[18px] group-hover:text-[${color}]/50`}>
                {title}
              </p>
