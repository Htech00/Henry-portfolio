      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10">
        <div className="space-y-8 mb-8 items-center">
          ...
          <div className="md:w-[432px]  rounded-md p-4 md:mb-6 border border-[#3c3c3c] font-mono">
            ...
            <a href="/public/Henry  Cv.pdf" className="flex items-center  gap-2 mx-auto  px-4 py-2 md:w-[166.8px] bg-[#3691c5] rounded-md text-white font-bold w-[200px] justify-center ">
